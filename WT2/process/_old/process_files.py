...
if __name__ == '__main__':
    ...
    #bn = 'WT+v2_unet-v1+pretrained_20190819_170413_adam-_lr1e-05_wd0.0_batch4'
    #bn = 'WT+v2+hard-neg_unet-v1_20190823_153141_adam-_lr0.0001_wd0.0_batch4'
    
    #bn = 'WT+v2+hard-neg-2_unet-v3-bn_20190906_113242_adam-_lr0.001_wd0.0_batch4'
    ...
    root_save_dir = Path.home() / 'workspace/WormData/egg_laying/predictions/' / bn
